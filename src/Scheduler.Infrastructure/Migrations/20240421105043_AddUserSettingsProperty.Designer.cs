...
namespace Scheduler.Infrastructure.Migrations
{
    ...
    [Migration("20240421105043_AddUserSettingsProperty")]
    partial class AddUserSettingsProperty
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Scheduler.Domain.UserAggregate.User", b =>
                {
                    ...
                    b.OwnsMany("Scheduler.Domain.UserAggregate.Entities.FriendsInvite", "FriendsInvites", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .HasColumnType("uuid");

                            b1.Property<Guid>("AddressieId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasIndex("AddressieId");

                            b1.HasIndex("SenderId");

                            b1.HasIndex("UserId");

                            b1.ToTable("FriendsInvite");

                            b1.HasOne("Scheduler.Domain.UserAggregate.User", null)
                                .WithMany()
